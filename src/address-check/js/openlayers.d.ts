...
declare module OpenLayers {
    ...
    module Feature {
        export class Vector {
            constructor(geometry: OpenLayers.Geometry, options: Object);
            //TODO
    ...
    module Layer {
        ...
        export class Vector extends Layer {
            ...
            addFeatures(features: OpenLayers.Feature.Vector[]): void
    ...
    module Request {
        ...
        export function PUT(config: Object);
        export function DELETE(config: Object);
        export function HEAD(config: Object);
        export function OPTIONS(config: Object);
